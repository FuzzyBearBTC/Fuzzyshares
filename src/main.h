...
static const int STAKE_TARGET_SPACING = 60 * 10; // peershares: 10 minute block spacing 
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 7; // peershares: Minimum age for coin age changed to 7 days 
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // peershares: Stake age of full weight
static const int64 IPO_SHARES = 100000000000 * COIN; // peershares: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 4000; // peershares: Block height of the last proof of work block
